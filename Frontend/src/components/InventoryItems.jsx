...
const InventoryItems = () => {
  ...
  const [items, setItems] = useState([
    ...
    //   stock: 10,
    //   inStock: "Yes",
    //   img: "https://res.cloudinary.com/deyfwd4ge/image/upload/v1716898875/download_3_lcvwbu.jpg",
    // },
    // {
    //   itemld: "02",
    //   itemName: "Bread",
    ...
    //   stock: 0,
    //   inStock: "No",
    //   img: "https://res.cloudinary.com/deyfwd4ge/image/upload/v1716898706/download_2_mhlll7.jpg",
    // },
  ]);
  ...
  useEffect(() => {
    ...
    axios
      .post(
        "http://localhost:8000/superadmin/fetchinventoryitems",
        { ID: item._id },
